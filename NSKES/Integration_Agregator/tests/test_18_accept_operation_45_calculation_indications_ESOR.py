...
response = requests.get(url = f'http://{server_ESOR}/info.v15.csp?OpCode=45&CSPID=TEST&BSPID=ESOR&RqUID=&CustID=24359&ProductCode=1&ServiceCode=1&CDate=2020-05-30&OpType=3&Param=30853&RPNum=1')
#  http://10.1.4.22/sirena-ordynsk/info.v15.csp?OpCode=45&CSPID=TEST&BSPID=ESOR&RqUID=&CustID=24359&ProductCode=1&ServiceCode=1&CDate=2020-05-30&OpType=3&Param=30853&RPNum=1
...
def test_check_P1():
    for element in root.iter(tag='P1'):
        assert element.text == '0', 'Значение не коректное'
