...
"""
import pytest
from conftest import server, server_ESBC
import requests
import xml.etree.ElementTree as ET

response = requests.get(url = f'http://{server_ESBC}/info.v15.csp?OpCode=1&CSPID=TEST&BSPID=ESBC&RqUID=&AcctID=200256')
#  http://10.1.4.22/sirena-chulym/info.v15.csp?OpCode=1&CSPID=TEST&RqUID=&AcctID=200256
