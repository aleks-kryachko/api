...
по Электичеству
Проверять на ТЕСТЕ server_test_ESOR (Ордынск)
"""

import pytest
from conftest import server_test_ESOR
import requests
import xml.etree.ElementTree as ET

date_pyment = '2020-09-06'
CustID ='101000000000012509'     #   Номер договора
AcctID ='5006057'     #   Номер ЛС
Sum ='3000'

response = requests.get(url = f'http://{server_test_ESOR}/csp.info.v15.cls?OpCode=30&TimeStamp={date_pyment}&OpType=3&CSPDivision=TEST&ProductCode=1&ServiceCode=1&CustID={CustID}&AcctID={AcctID}&CDate={date_pyment}&QValue=1&Sum={Sum}&RPNum=1&OpID=111&TerminalID=222')
